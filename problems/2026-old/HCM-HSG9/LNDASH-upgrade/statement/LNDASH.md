...
### LNDASH - Trò chơi LineDash (bản sửa)

**Lưu ý:** Tại phiên bản này, giới hạn được sửa lại:
- $0 \le L_i \le R_i \le T$
thay vì  $0 \le L_i \le R_i \le N$ như trong đề gốc đã ghi.

Nguyên nhân là do nếu giữ nguyên giới hạn như vậy thì bài này trở nên quá đơn giản và có phần không phù hợp với xu hướng ra đề gần đây. Do vậy mình tạo một phiên bản mới để bài toán khó một cách hợp lý hơn.
...
- $Q$ dòng tiếp theo, mỗi dòng gồm hai số nguyên $L_i, R_i$ $(\boxed{0 \le L_i, R_i \le T})$
